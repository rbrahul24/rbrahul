...
ugen=['Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/535.11 (KHTML, like Gecko) Ubuntu/11.10 Chromium/27.0.1453.93 Chrome/27.0.1453.93 Safari/537.36']
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                print(' Sdcard/RAHUL-OK')
                                print(' sdcard/RAHUL-CP')
                                print(' sdcard/RB COOKIES')
