...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print("\33[1;37m----------------------------------------------")
      print("\33[1;37mBaat Suno Bhai Log Tools Free Ma Approval Mil Jayega Sabko")  
      print('Ek Madarchod Sala Junaid Khan Ha Jo Sabke Saath Scaam Kar rha hai mere saath bhi kar gaya to isko itna jalil karo sab log tabhi line me aagega') 
      print('Karna hai Cmd Run hone k baad uska id open hoga aur usi id ko report karke muje ss bhejo aur approval mil jayega sab log ko') 
      print('\33[1;37m----------------------------------------------')
      input('Report karo aur jitna gali de saktey ho de kar muje ss bhejna tabhi approval milega') 
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+91877t='+tks),approval()
      time.sleep(1)
      approval()
  except:
    os.system('python RAHUL.py')
